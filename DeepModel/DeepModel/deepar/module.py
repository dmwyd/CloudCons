    ...
    *Note:* the code of this model is unrelated to the implementation behind
    ...
    def loss(
        ...
        if future_only:
            ...
            distr = self.distr_output.distribution(distr_args=sliced_params, scale=scale)
            loss_values = distr.log_prob(future_target_reshaped)
            ...
            distr = self.distr_output.distribution(distr_args=params, scale=scale)
            loss_values = distr.log_prob(target)
